...
class EditExpenseScreenMobile extends StatefulWidget {
  const EditExpenseScreenMobile({Key? key, required this.expense})
      : super(key: key);

  final Expense expense;

  static const routeName = 'EditExpenseMobile';

  @override
  _EditExpenseScreenMobileState createState() =>
      _EditExpenseScreenMobileState();
}

class _EditExpenseScreenMobileState extends State<EditExpenseScreenMobile> {
  String expenseTitle = "";
