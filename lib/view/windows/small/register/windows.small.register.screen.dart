...
class WindowsSmallRegScreen extends StatefulWidget {
  const WindowsSmallRegScreen({Key? key}) : super(key: key);

  @override
  _WindowsSmallRegScreenState createState() => _WindowsSmallRegScreenState();
}

class _WindowsSmallRegScreenState extends State<WindowsSmallRegScreen> {
  String email = "";
  String password = "";
