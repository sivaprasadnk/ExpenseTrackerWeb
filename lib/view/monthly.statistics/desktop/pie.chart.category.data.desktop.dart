...
class PieChartCategoryDataDesktop extends StatefulWidget {
  const PieChartCategoryDataDesktop({Key? key}) : super(key: key);

  @override
  State<PieChartCategoryDataDesktop> createState() =>
      _PieChartCategoryDataDesktopState();
}

class _PieChartCategoryDataDesktopState
    extends State<PieChartCategoryDataDesktop> {
  @override
